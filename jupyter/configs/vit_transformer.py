# Konfiguracja Mask R-CNN z backbone ViT
# Upewnij się, że podany _base_ istnieje w Twojej wersji MMDetection

_base_ = 'mmdet::mask_rcnn/mask-rcnn_vit-b-p16_fpn_1x_coco.py'

# Ścieżki do danych COCO wygenerowanych w tym projekcie
#data_root = 'data_coco/'
